...
class TestDatabaseJSONAdapters:
    ...
    def test_configure_json_adapters_enabled(self, mock_json, database_settings_with_json, mock_connection):
        ...
        mock_json.set_json_loads.assert_called_once_with(loads=mock_json.json.loads, context=mock_connection)
        mock_json.set_json_dumps.assert_called_once_with(dumps=mock_json.json.dumps, context=mock_connection)
    ...
    @patch("psycopg_toolkit.core.database.json")
    async def test_connection_context_configures_json_adapters(
        self, mock_json, mock_get_pool, database_settings_with_json, mock_pool, mock_connection
    ):
    ...
    @patch("psycopg_toolkit.core.database.Database.get_pool")
    @patch("psycopg_toolkit.core.database.json")
    async def test_transaction_context_configures_json_adapters(
        self, mock_json, mock_get_pool, database_settings_with_json, mock_pool, mock_connection
    ):
    ...
    @patch("psycopg_toolkit.core.database.Database.get_pool")
    @patch("psycopg_toolkit.core.database.json")
    async def test_connection_without_json_adapters(
        self, mock_json, mock_get_pool, database_settings_without_json, mock_pool, mock_connection
    ):
    ...
    async def test_json_adapter_logging_enabled(
        self, mock_logger, mock_json, mock_get_pool, database_settings_with_json, mock_pool, mock_connection
    ):
    ...
    @patch("psycopg_toolkit.core.database.Database.get_pool")
    @patch("psycopg_toolkit.core.database.logger")
    async def test_json_adapter_logging_disabled(
        self, mock_logger, mock_get_pool, database_settings_without_json, mock_pool, mock_connection
    ):
    ...
    @patch("psycopg_toolkit.core.database.Database.get_pool")
    async def test_transaction_manager_gets_json_configurator(
        self, mock_get_pool, database_settings_with_json, mock_pool
    ):
        ...
        with patch("psycopg_toolkit.core.transaction.TransactionManager") as mock_tm_class:
            await database.get_transaction_manager()
