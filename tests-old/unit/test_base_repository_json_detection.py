...
class TestBaseRepositoryJSONDetection:
    ...
    def test_auto_detect_json_fields(self, mock_connection):
        ...
        repo = BaseRepository(
            db_connection=mock_connection, table_name="test_table", model_class=SampleModel, primary_key="id"
        )
    ...
    def test_simple_model_no_json_fields(self, mock_connection):
        ...
        repo = BaseRepository(
            db_connection=mock_connection, table_name="simple_table", model_class=SimpleModel, primary_key="id"
        )
    ...
    def test_default_parameters(self, mock_connection):
        ...
        repo = BaseRepository(db_connection=mock_connection, table_name="test_table", model_class=SampleModel)
    ...
    def test_complex_model_json_detection(self, mock_connection):
        ...
        repo = BaseRepository(
            db_connection=mock_connection, table_name="user_profiles", model_class=UserProfile, primary_key="id"
        )

        expected_fields = {"metadata", "preferences", "tags", "settings", "custom_fields", "profile_data"}
