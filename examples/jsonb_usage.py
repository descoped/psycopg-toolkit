...
class UserProfile(BaseModel):
    ...
    profile_data: Optional[Dict[str, Any]] = None  # Optional JSONB field
...
async def example_2_explicit_json_configuration(db: Database):
    ...
    async with db.connection() as conn:
        ...
        updated_product = await product_repo.update(created_product.id, {
...
async def example_3_strict_json_processing(db: Database):
    ...
    async with db.connection() as conn:
        ...
        try:
            ...
            await doc_repo.update(created_doc.id, {
                "content": {
