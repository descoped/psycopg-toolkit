...
async def demo_user_operations(db: Database):
    ...
    async with db.connection() as conn:
        ...
        updated_user = await user_repo.update(
            created_user.id, {"preferences": {**retrieved.preferences, "theme": "light", "new_feature_beta": True}}
        )
...
async def demo_product_operations(db: Database):
    ...
    async with db.connection() as conn:
        ...
        laptop = Product(
            ...
            specifications={
                "processor": {"brand": "Apple", "model": "M3 Pro", "cores": 12, "architecture": "ARM64"},
                "memory": {"size_gb": 32, "type": "Unified Memory", "bandwidth": "400 GB/s"},
                "storage": {"size_gb": 1000, "type": "SSD", "interface": "NVMe"},
                "display": {
                    "size_inches": 16.2,
                ...
                "connectivity": {"thunderbolt_ports": 3, "hdmi": "2.1", "wifi": "WiFi 6E", "bluetooth": "5.3"},
                "dimensions": {"width_mm": 355.7, "depth_mm": 248.1, "height_mm": 16.8, "weight_kg": 2.16},
            },
        ...
        print(
            f"   Processor: {retrieved.specifications['processor']['brand']} {retrieved.specifications['processor']['model']}"
        )
